...
<body>
<%-- 
	<h3>1. 기존 방식대로 스크립틀릿 표현식을 이용하여 각 scope에 담겨있는 값을 화면에 출력</h3>
	<%
		//request scope값 가져오기
	...
	<p>
	EL을 이용하여 getxxx을 통해 값을 가져올 필요없이 EL구문 내의 키값만 제시하면 바로 접근이 가능 <br>
	기본적으로 EL은 JSP내장객체를 구분하지 않고 자동으로 모든 내장객체의 키값을 검색하여 존재하는 경우 그 값을 가져옴
