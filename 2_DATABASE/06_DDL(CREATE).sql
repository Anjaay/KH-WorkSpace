...
/*
    ...
    *자료형
    - 문자(CHAR(바이트 크기) | VARCHAR2(바이트 크기)) -> 반드시 크기 지정을 해줘야 함
        - CHAR : 최대 2000바이트까지 지정가능 / 고정길이(고정된 글자수 데이토가 담길 경우)
...
CREATE TABLE MEMBER(
    MEM_NO NUMBER,
    MRM_ID VARCHAR2(20), -- user01, wldnjs1004
    MEM_PWD VARCHAR2(20),
...
/*
    ...
    [표현법]
    CONNECT ON COLUMN 테이블명.컬럼명 IS '주성내용';
    -> 잘못 작성시 새로 수정하면 된다.
*/

COMMENT ON COLUMN MEMBER.MEM_NO IS '회원번호';
COMMENT ON COLUMN MEMBER.MRM_ID IS '회원아이디';
...
-- INSERT INTO 테이블명 VALUES(1. 'USER1', 'PASS1', '홍길동', '남', '010-111-2222', 'AAAA@NAVER,COM', '24/08/12');
INSERT INTO MEMBER
VALUES(1, 'USER1', 'PASS1', '홍길동', '남', '010-111-2222', 'AAAA@NAVER,COM', '24/08/12');

INSERT INTO MEMBER
VALUES(1, 'USER1', 'PASS1', NULL, NULL, '010-111-2222', NULL, '24/08/12');

INSERT INTO MEMBER
VALUES(1, 'USER1', 'PASS1', '홍길동', '나', '010-111-2222', 'AAAA@NAVER,COM', '24/08/12');
...
-- 의도했던대도 오류가 발생한다.(NOT NULL 제약조건 위배)
...
--> GENDER컬럼에는 CHECK 제약조건을 만족하는 값을 넣어야한다.
--> 단 NULL은 값이 없단느 뜻이기 때문에 가능하다.
...
/*
    ...
    EX) 회원번호, 학번, 군번, 부서코드, 직급코드, 주민번호, 택배운송장번호, 예약번호....
...
--> 기본키에 NULL을 담으려고 할 떄(NOT NULL제약조건 위배)
...
INSERT INTO MEM_PRI2 VALUES(2, 'USER3', 'PASS4', '홍길서', '나', NULL, NULL, NULL);
...
/*
    ...
    * 삭제옵션 : 부모테이블의 데이터 삭제시 그 데이터를 사용하고 있는 자식테이블의 값을 어떻게 할것인가?
    ...
    -ON DELETE RESTRAICTED(기본값): 삭제제한옵션 , 자식데이터로부터 쓰이는 부모데이터는 삭제가 아예 안됨
