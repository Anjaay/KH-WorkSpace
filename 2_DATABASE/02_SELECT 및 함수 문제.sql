...
SELECT EMP_NAME, SALARY, 
        (SALARY + (SALARY*BONUS))*12 - (SALARY + (SALARY*NVL(BONUS,0)))*12*0.03 AS "실수령액", 
        HIRE_DATE
FROM EMPLOYEE
WHERE ((SALARY + (SALARY*BONUS))*12 - (SALARY + (SALARY*NVL(BONUS,0)))*12*0.03) >= 50000000;
